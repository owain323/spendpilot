...
| E2 | Benchmarks: 12 public regression fixtures 12/12 + 24-case hidden holdout 24/24 (labels gitignored; seeded generator) | ✅ verified — `benchmarks/results/metrics.json`, `benchmarks/results/holdout-metrics.json` |
